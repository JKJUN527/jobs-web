...
jQuery.validator.addMethod("posInt",function(value, element) {
	var posInt = /^\b[1-9]\b|([1-9]\d+)$/
	return this.optional(element) || (posInt.test(value));
},"请输入大于0的整数");

jQuery.validator.addMethod("posInt30",function(value, element) {
	var posInt = /^\b[1-9]\b|([1-9]\d+)$/;
	return this.optional(element) || ((posInt.test(value))&&(value < 31));
},"请输入1~30的整数");

jQuery.validator.addMethod("posInt9999",function(value, element) {
	var posInt = /^\b[1-9]\b|([1-9]\d+)$/;
	return this.optional(element) || ((posInt.test(value))&&(value < 9999));
},"请输入1~9999的整数");
